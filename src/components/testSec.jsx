        ...
        <div className="flex flex-col mb-10" id="testsec">
            ...
            <div className="flex mx-auto">
                <div className="w-96 h-[400px] relative bg-red-300 flex flex-col mx-2">
                    ...
                    <img className="w-24 h-24 rounded-full mx-auto mt-6 border-4" src="elon.jpg" />
                ...
                <div className="w-96 h-[400px] relative bg-red-300 flex flex-col mx-2">
                    ...
                    <img className="w-24 h-24 rounded-full mx-auto mt-6 border-4" src="andy.jpg" />
                    <div className="m-auto">
                ...
                <div className="w-96 h-[400px] relative bg-red-300 flex flex-col mx-2">
                    ...
                    <img className="w-24 h-24 rounded-full mx-auto mt-6 border-4" src="oak.jpg" />
                    <div className="m-auto">
